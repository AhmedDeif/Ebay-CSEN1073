...
public class Cache {
	...
	protected static void connectToDB(String strAddress, int nPort, String strDBName, String strUserName,
			String strPassword) throws Exception {
		Class.forName("org.postgresql.Driver");
		_connection = DriverManager.getConnection("jdbc:postgresql://" + strAddress + ":" + nPort + "/" + strDBName,
